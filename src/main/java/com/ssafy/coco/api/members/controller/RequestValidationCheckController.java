...
public class RequestValidationCheckController {
	...
	public boolean validateRequest(@RequestBody @ApiParam(value = "브라우저에 있는 사용자 ID", required = true) String userId,
		HttpServletRequest request) {
		String accessToken = request.getHeader("Authorization");
		return jwtTokenService.validateRequest(userId, accessToken);
	}
